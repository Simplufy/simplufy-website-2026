export const faqs: { q: string; a: string }[] = [
  {
    q: 'What industries does Simplufy work with?',
    a: 'Service businesses that run on booked opportunities: auto detailing and styling shops, roofing, plumbing, pest control, landscaping, window companies, smart home installers, contractors, med spas, B2B service firms, and education and training organizations. The playbook changes by industry because buyer intent, trust signals, seasonality, and follow-up needs change with it.'
  },
  {
  ...
  },
  {
    ...
    a: 'SEO gets your pages ranking in traditional Google search for service, problem, and location keywords. AEO (answer engine optimization) structures content so it directly answers the questions buyers ask, and GEO (generative engine optimization) improves how AI search tools understand and cite your brand. We run them as one program: be findable wherever your buyer is asking.'
  },
  {
  ...
  },
  {
    ...
    a: 'Yes. For location-based companies the work spans service and location pages, technical SEO, internal linking, Google Business Profile direction, review strategy, schema, and FAQ content that answers what buyers in your market actually ask. The same set of useful pages supports both map visibility and organic search demand.'
  },
  {
    q: 'What kind of AI implementation does Simplufy provide?',
    a: 'Practical workflows, not hype: AI-assisted intake, lead routing, follow-up drafting, reporting summaries, content and research workflows, and agent orchestration for repetitive operations. Every system keeps clear human review points so it stays reliable instead of becoming a fragile black box.'
  },
  {
    q: 'Will the site be optimized for Cloudflare hosting?',
    a: 'Yes. We build fast static Astro sites that deploy cleanly to Cloudflare Pages, with strong performance and a structure that scales as service, industry, and case study pages are added. Speed is part of the SEO and conversion math, not an afterthought.'
  },
  {
  ...
  },
  {
    ...
    a: 'Systems instead of tactics. A typical agency sells a website, SEO, or ads in isolation; Simplufy connects the website, ads, CRM, search, and AI into one tracked system aimed at booked opportunities. You can see the page a buyer landed on, the form they submitted, the follow-up they received, and what it produced.'
  },
  {
    q: 'How do we get started?',
    a: 'Book a strategy call. We review your website, lead sources, CRM, follow-up, and tracking, then point at the biggest leak and what should be fixed first. From there the work becomes a practical roadmap instead of a rebuild-everything project.'
  }
];
